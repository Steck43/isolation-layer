...
| Disposable inspector **host stage** | **RECORD** B3.2a — retrieve-by-hash + dispose |
| Disposable inspector VM (hash-verify) | **RECORD** B3.2b — one-shot FC + vsock |
| Richer inspect verdict (Q0/Q1 judgment) | **VISION** |
