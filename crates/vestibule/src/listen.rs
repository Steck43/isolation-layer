...
pub fn serve_one_with_opts(
    ...
    if opts.harden {
        ...
        eprintln!(
            "vestibule_harden euid={} egid={} no_new_privs={} dumpable_cleared={} seccomp_deny_exec={} seccomp_deny_dangerous={} seccomp_allowlist={} seccomp_prot_exec_filter={} rlimit_core_zero={}",
            report.euid, report.egid, report.no_new_privs, report.dumpable_cleared,
            report.seccomp_deny_exec, report.seccomp_deny_dangerous, report.seccomp_allowlist, report.seccomp_prot_exec_filter, report.rlimit_core_zero
        );
    }
